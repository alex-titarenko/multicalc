 ...
 */
export class GaussKronrodQuadratures {
  private static readonly XGK15: number[] = [
  ...
  private static readonly WGK15: number[] = [
  ...
  private static readonly WG7: number[] = [
  ...
  private static readonly XGK21: number[] = [
  ...
  private static readonly WGK21: number[] = [
  ...
  private static readonly WGK31: number[] = [
  ...
  private static readonly WG15: number[] = [
  ...
  private static readonly XGK41: number[] = [
  ...
  private static readonly WGK41: number[] = [
  ...
  private static readonly WG20: number[] = [
  ...
  private static readonly XGK51: number[] = [
  ...
  private static readonly WGK51: number[] = [
  ...
  private static readonly WG25: number[] = [
  ...
  private static readonly XGK61: number[] = [
  ...
  private static readonly WGK61: number[] = [
  ...
  private static readonly WG30: number[] = [
   ...
   */
  public static gaussKronrod15Rule(integrand: Func<Complex>, lowerBound: number, upperBound: number): Complex {
    let result = Complex.zero;

    const centre = 0.5 * (lowerBound + upperBound);
    const hlgth = 0.5 * (upperBound - lowerBound);

    for (let i = 0; i < 7; i++) {
      const abscissa = hlgth * GaussKronrodQuadratures.XGK15[i];
      const f1 = integrand(Complex.fromReal(centre - abscissa));
      const f2 = integrand(Complex.fromReal(centre + abscissa));

      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK15[i]), f1));
      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK15[i]), f2));
    }

    result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK15[7]), integrand(Complex.fromReal(centre))));

    return Complex.mult(Complex.fromReal(hlgth), result);
  }
   ...
   * @param upperBound The upper integration limit.
   */
  public static gaussKronrod21Rule(integrand: Func<Complex>, lowerBound: number, upperBound: number): Complex {
    let result = Complex.zero;
    ...
    for (let i = 0; i < 10; i++) {
      const abscissa = hlgth * GaussKronrodQuadratures.XGK21[i];
      const f1 = integrand(Complex.fromReal(centre - abscissa));
      const f2 = integrand(Complex.fromReal(centre + abscissa));

      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK21[i]), f1));
      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK21[i]), f2));
    }

    result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK21[10]), integrand(Complex.fromReal(centre))));
   ...
   * @param upperBound The upper integration limit.
   */
  public static gaussKronrod31Rule(integrand: Func<Complex>, lowerBound: number, upperBound: number): Complex {
    let result = Complex.zero;
    ...
    for (let i = 0; i < 15; i++) {
      const abscissa = hlgth * GaussKronrodQuadratures.XGK31[i];
      const f1 = integrand(Complex.fromReal(centre - abscissa));
      const f2 = integrand(Complex.fromReal(centre + abscissa));

      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK31[i]), f1));
      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK31[i]), f2));
    }

    result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK31[15]), integrand(Complex.fromReal(centre))));
   ...
   * @param upperBound The upper integration limit.
   */
  public static gaussKronrod41Rule(integrand: Func<Complex>, lowerBound: number, upperBound: number): Complex {
    let result = Complex.zero;
    ...
    for (let i = 0; i < 20; i++) {
      const abscissa = hlgth * GaussKronrodQuadratures.XGK41[i];
      const f1 = integrand(Complex.fromReal(centre - abscissa));
      const f2 = integrand(Complex.fromReal(centre + abscissa));

      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK41[i]), f1));
      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK41[i]), f2));
    }

    result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK41[20]), integrand(Complex.fromReal(centre))));
   ...
   * @param upperBound The upper integration limit.
   */
  public static gaussKronrod51Rule(integrand: Func<Complex>, lowerBound: number, upperBound: number): Complex {
    let result = Complex.zero;
    ...
    for (let i = 0; i < 25; i++) {
      const abscissa = hlgth * GaussKronrodQuadratures.XGK51[i];
      const f1 = integrand(Complex.fromReal(centre - abscissa));
      const f2 = integrand(Complex.fromReal(centre + abscissa));

      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK51[i]), f1));
      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK51[i]), f2));
    }

    result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK51[25]), integrand(Complex.fromReal(centre))));
   ...
   * @param upperBound The upper integration limit.
   */
  public static gaussKronrod61Rule(integrand: Func<Complex>, lowerBound: number, upperBound: number): Complex {
    let result = Complex.zero;
    ...
    for (let i = 0; i < 30; i++) {
      const abscissa = hlgth * GaussKronrodQuadratures.XGK61[i];
      const f1 = integrand(Complex.fromReal(centre - abscissa));
      const f2 = integrand(Complex.fromReal(centre + abscissa));

      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK61[i]), f1));
      result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK61[i]), f2));
    }

    result = result.add(Complex.mult(Complex.fromReal(GaussKronrodQuadratures.WGK61[30]), integrand(Complex.fromReal(centre))));
